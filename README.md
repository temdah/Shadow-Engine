...
Version 1.2.4 retains the five Global, Shev, VMPless, Asia/Miru and Complete
...
`Watch_Dogs\bin\ShadowEnginePatch.log`. For v1.2.4, the log should identify
`version=1.2.4` and contain `STAGE_M_COMPLETE`.
